...
<head>
  <title>Introducing cabi Tap</title>
  <!--[if !mso]><!-- -->
...
<![endif]-->
  ...
  <style type="text/css">
    @media only screen and (max-width:480px) {
      ...
      .nvbtn>td>table>tbody>tr>td>a>span {
...
<body style="background:#fff">
  <div style="display:none;font-size:1px;color:#fff;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden">cabi style is just a tap away</div>
  <div class="mj-container" style="background-color:#d7d7d7">
    <!--[if mso | IE]>
    ...
    <div style="margin:0 auto;max-width:600px;background:#fff">
      ...
      <![endif]-->
              <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;background:#fff;display:inline-block;font-size:0;line-height:0;text-align:left;width:100%">
                <!--[if mso | IE]>
      <table bgcolor="#ffffff" role="presentation" border="0" cellpadding="0" cellspacing="0">
        <tr>
                    ...
                    <tbody>
                      <tr>
                        <td style="word-wrap:break-word;font-size:0;padding:0">
                          <div style="font-size:1px;line-height:5px;white-space:nowrap"> </div>
                        </td>
                      </tr>
                    </tbody>
                  </table>
      ...
      <![endif]-->
                <div class="mj-column-per-33 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:33%">
                  <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;border-bottom:1px solid #000" width="100%" border="0">
                    <tbody>
                      <tr>
      ...
      <![endif]-->
              <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0;padding-top:30px" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:600px"><img alt="Introducing cabi Tap" height="auto" src="./images/introducing.gif" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:auto" width="600"></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0" align="center">
                        <div style="cursor:auto;color:#000;font-family:Arial,sans-serif;font-size:16px;font-weight:100;line-height:22px;text-align:center">
                          <!-- remove style from h2 before final output-->
                          <h2 style="font-weight:100;font-size:18px;line-height:26px">Our new app serving up 24/7 style is just a tap away!</h2>
                        </div>
                      </td>
                    </tr>
                  </tbody>
      ...
      <![endif]-->
              <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0;padding-bottom:20px" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:600px"><a href="#" target="_blank" style="color:#000;font-weight:700"><img alt="Why you'll love it video" height="auto" src="./images/why_youll_love_it.png" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:auto" width="600"></a></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
    ...
    <div style="margin:0 auto;max-width:600px;background:#fff">
      <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0;width:100%;background:#fff" align="center" border="0">
        <tbody>
          <tr>
            <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0;padding:0;padding-bottom:20px">
              <!--[if mso | IE]>
      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
        <tr>
      ...
      <![endif]-->
              <div class="mj-column-per-50 outlook-group-fix" style="vertical-align:middle;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;vertical-align:middle" width="100%" border="0">
                  <tbody>
                    <tr class="ariahidden" style="aria-hidden:true">
                      <td style="word-wrap:break-word;font-size:0;padding:0" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
      ...
      <![endif]-->
              <div class="mj-column-per-50 outlook-group-fix" style="vertical-align:middle;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;vertical-align:middle" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0 15px" align="left">
    ...
    <div style="margin:0 auto;max-width:600px;background:#fff">
      <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0;width:100%;background:#fff" align="center" border="0">
        <tbody>
          <tr>
            <td style="text-align:center;vertical-align:top;direction:rtl;font-size:0;padding:0;padding-bottom:20px">
              <!--[if mso | IE]>
      <table role="presentation" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td style="vertical-align:middle;width:300px;">
                    ...
                    <tr class="ariahidden" style="aria-hidden:true">
                      <td style="word-wrap:break-word;font-size:0;padding:0" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:300px" align="center"><img alt="match your favorites with clothes from your closet" height="auto" src="./images/match_favorites_to_closet.png" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:85%;height:auto"
                                  width="300"></td>
                            </tr>
                          </tbody>
                        </table>
      ...
      <![endif]-->
              <div class="mj-column-per-50 outlook-group-fix" style="vertical-align:middle;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;vertical-align:middle" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0 15px" align="right">
                        <div style="cursor:auto;color:#000;font-family:Arial,sans-serif;font-size:16px;font-weight:100;line-height:22px;text-align:right">
                    ...
                    <tr class="ariahidden" style="aria-hidden:true">
                      <td style="word-wrap:break-word;font-size:0;padding:0" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:300px" align="center"><img alt="order electronically" height="auto" src="./images/order_electronically.png" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:85%;height:auto" width="300"></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                    ...
                    <tr class="ariahidden" style="aria-hidden:true">
                      <td style="word-wrap:break-word;font-size:0;padding:0" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:300px" align="center"><img alt="daily personalized outfit ideas" height="auto" src="./images/daily_personalized_outfits.png" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:85%;height:auto"
                                  width="300"></td>
                            </tr>
                          </tbody>
                        </table>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:600px"><img alt="ready to start tapping?" height="auto" src="./images/ready_to_start_tapping.gif" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:auto" width="600"></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0" align="center">
                        <div style="cursor:auto;color:#000;font-family:Arial,sans-serif;font-size:16px;font-weight:100;line-height:22px;text-align:center">
                          <h2 style="font-weight:100;font-size:18px;line-height:26px">Getting the app is easy as 1-2-3!</h2>
                        </div>
                      </td>
                    </tr>
                  </tbody>
      ...
      <![endif]-->
              <div class="mj-column-per-33 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0;padding-top:15px" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:200px"><img alt="step 1" height="auto" src="./images/step1.gif" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:auto" width="200"></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0 5px 5px 5px" align="center">
                        <div style="cursor:auto;color:#000;font-family:Arial,sans-serif;font-size:16px;font-weight:100;line-height:22px;text-align:center">
                          <p>Download cabi Tap</p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
              ...
              <!--[if mso | IE]>
      </td><td style="vertical-align:top;width:200px;" class="tbpborder-outlook">
      <![endif]-->
              <div class="mj-column-per-33 outlook-group-fix tbpborder" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;border-left:1px solid #ff99a7;border-right:1px solid #ff99a7" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0;padding-top:15px" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:200px"><img alt="step 2" height="auto" src="./images/step2.gif" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:auto" width="200"></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0 5px 5px 5px" align="center">
                        <div style="cursor:auto;color:#000;font-family:Arial,sans-serif;font-size:16px;font-weight:100;line-height:22px;text-align:center">
                          <p>Register, then log in with your email address</p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0;padding-top:15px" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:200px"><img alt="step 3" height="auto" src="./images/step3.gif" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:auto" width="200"></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0 5px 5px 5px" align="center">
                        <div style="cursor:auto;color:#000;font-family:Arial,sans-serif;font-size:16px;font-weight:100;line-height:22px;text-align:center">
                          <p>Complete your profile questionnaire</p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
      ...
      <![endif]-->
              <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:30px 0 10px 0" align="center">
    ...
    <div style="margin:0 auto;max-width:600px;background:#fff">
      ...
      <![endif]-->
              <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;border-bottom:2px solid #000" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:10px 30px 0 10px" align="center">
                        <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                          <tbody>
                            <tr>
                              <td style="width:560px"><img alt="Your cabi stylist" height="auto" src="./images/your_cabi_stylist.gif" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:auto" width="560"></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
    ...
    <div style="margin:0 auto;max-width:600px;background:#fff">
      ...
      <![endif]-->
              <div class="mj-column-per-16 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff" width="100%" border="0">
                  <tbody>
                    <tr class="nvbtn">
                      <td style="word-wrap:break-word;font-size:0;padding:0" align="center">
              ...
              <!--[if mso | IE]>
      </td><td style="vertical-align:top;width:100px;">
      <![endif]-->
              <div class="mj-column-per-16 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff" width="100%" border="0">
                  <tbody>
      ...
      <![endif]-->
              <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff" width="100%" border="0">
                  <tbody>
                    <tr>
                      <td style="word-wrap:break-word;font-size:0;padding:0;padding-top:20px" align="center">
                        <div>
                          <!--[if mso | IE]>
                            ...
                            <tbody>
                              <tr>
                                <td style="padding:8px;vertical-align:middle">
                                  <table role="presentation" cellpadding="0" cellspacing="0" style="background:#ff99a7;border-radius:3px;width:40px" border="0">
                                    <tbody>
                                      <tr>
                                        <td style="font-size:0;vertical-align:middle;width:40px;height:40px;"><a href="https://twitter.com/cabiclothing/" style="color:#000;font-weight:700"><img alt="twitter" height="40" src="./images/twittericon.png" style="display:block;border-radius:3px" width="40"></a></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
                              ...
                              <tr>
                                <td style="padding:8px;vertical-align:middle">
                                  <table role="presentation" cellpadding="0" cellspacing="0" style="background:#ff99a7;border-radius:3px;width:40px" border="0">
                                    <tbody>
                                      <tr>
                                        <td style="font-size:0;vertical-align:middle;width:40px;height:40px;"><a href="https://facebook.com/cabiclothing/" style="color:#000;font-weight:700"><img alt="facebook" height="40" src="./images/facebookicon.png" style="display:block;border-radius:3px" width="40"></a></td>
                                      </tr>
                                    </tbody>
                                  </table>
								  </td>
                              ...
                              <tr>
                                <td style="padding:8px;vertical-align:middle">
                                  <table role="presentation" cellpadding="0" cellspacing="0" style="background:#ff99a7;border-radius:3px;width:40px" border="0">
                                    <tbody>
                                      <tr>
                                        <td style="font-size:0;vertical-align:middle;width:40px;height:40px"><a href="https://www.instagram.com/cabiclothing/" style="color:#000;font-weight:700"><img alt="instagram" height="40" src="./images/instagramicon.png" style="display:block;border-radius:3px" width="40"></a></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
                              ...
                              <tr>
                                <td style="padding:8px;vertical-align:middle">
                                  <table role="presentation" cellpadding="0" cellspacing="0" style="background:#ff99a7;border-radius:3px;width:40px" border="0">
                                    <tbody>
                                      <tr>
                                        <td style="font-size:0;vertical-align:middle;width:40px;height:40px"><a href="https://www.pinterest.com/cabiclothing/" style="color:#000;font-weight:700"><img alt="pinterest" height="40" src="./images/pinteresticon.png" style="display:block;border-radius:3px" width="40"></a></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
                              ...
                              <tr>
                                <td style="padding:8px;vertical-align:middle">
                                  <table role="presentation" cellpadding="0" cellspacing="0" style="background:#ff99a7;border-radius:3px;width:40px" border="0">
                                    <tbody>
                                      <tr>
                                        <td style="font-size:0;vertical-align:middle;width:40px;height:40px"><a href="https://www.youtube.com/cabiclothing/" style="color:#000;font-weight:700"><img alt="pinterest" height="40" src="./images/youtubeicon.png" style="display:block;border-radius:3px" width="40"></a></td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
